...
public class TCRMServicesWebServiceLocator extends org.apache.axis.client.Service implements com.monedafrontera.services.tcrm.action.TCRMServicesWebService {
    ...
    public com.monedafrontera.services.tcrm.action.TCRMServicesInterface getTCRMServicesWebServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.monedafrontera.services.tcrm.action.TCRMServicesInterface getTCRMServicesWebServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.monedafrontera.services.tcrm.action.TCRMServicesWebServiceSoapBindingStub _stub = new com.monedafrontera.services.tcrm.action.TCRMServicesWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.monedafrontera.services.tcrm.action.TCRMServicesInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.monedafrontera.services.tcrm.action.TCRMServicesWebServiceSoapBindingStub _stub = new com.monedafrontera.services.tcrm.action.TCRMServicesWebServiceSoapBindingStub(new java.net.URL(TCRMServicesWebServicePort_address), this);
                _stub.setPortName(getTCRMServicesWebServicePortWSDDServiceName());
                return _stub;
            }
        }
