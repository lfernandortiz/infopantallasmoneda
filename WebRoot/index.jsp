...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="10; url =${pageContext.request.contextPath}/ServletControlador?accion=actualizar"/>
    ...
    <body>
        <div class="homediv">
            <img src="img/Moneda_Blanco_ini.png" width="800" height="318" alt="Moneda_Blanco_ini"/>
        </div>
    <body>
